...
function Hero() {
  return (
    <div className="grid justify-items-center gap-8 pb-28 relative">
      <p className="text-4xl md:text-6xl font-black text-center leading-normal  md:leading-norma">
      ...
      <div>
        ...
        <button className="rounded bg-gray-900 text-bae text-white py-3 px-8 ml-2">
          了解更多
        </button>
      </div>
      ...
      <div className="relative grid justify-items-center">
        ...
        ></video>
        <div className="flex absolute rounded-full bg-white -buttom-7 px-5 py-4 drop-shadow-xl">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
